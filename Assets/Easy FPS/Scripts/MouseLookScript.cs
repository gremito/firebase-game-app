...
//		wantedYRotation += Input.GetAxis("Mouse X") * mouseSensitvity;
		wantedYRotation += CrossPlatformInputManager.GetAxis("Mouse X") * mouseSensitvity;
	
//		wantedCameraXRotation -= Input.GetAxis("Mouse Y") * mouseSensitvity;
		wantedCameraXRotation -= CrossPlatformInputManager.GetAxis("Mouse Y") * mouseSensitvity;
