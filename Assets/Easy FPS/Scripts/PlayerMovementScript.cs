...
//			rb.AddRelativeForce (Input.GetAxis ("Horizontal") * accelerationSpeed * Time.deltaTime, 0, Input.GetAxis ("Vertical") * accelerationSpeed * Time.deltaTime);
			rb.AddRelativeForce (
				CrossPlatformInputManager.GetAxis("Horizontal") * accelerationSpeed * Time.deltaTime, 
				0, 
				CrossPlatformInputManager.GetAxis("Vertical") * accelerationSpeed * Time.deltaTime);
		} 
		else 
		{
//			rb.AddRelativeForce (Input.GetAxis ("Horizontal") * accelerationSpeed / 2 * Time.deltaTime, 0, Input.GetAxis ("Vertical") * accelerationSpeed / 2 * Time.deltaTime);
			rb.AddRelativeForce (
				CrossPlatformInputManager.GetAxis("Horizontal") * accelerationSpeed / 2 * Time.deltaTime, 
				0, 
				CrossPlatformInputManager.GetAxis("Vertical") * accelerationSpeed / 2 * Time.deltaTime);
